  ...
  return (
    <div className="max-w-7xl mx-auto py-[9.6rem] px-[2rem] md:px-[4.6rem]">
      ...
      <div className="relative max-w-[90rem] aspect-video mx-auto">
        ...
        <div className="absolute bottom-4 right-4 bg-gold-lighter/15 w-[65%] sm:w-[50%] backdrop-blur-lg rounded-sm flex gap-3 p-2 sm:p-3">
          {imgArray.map((img, index) => (
            <div
              className="relative w-[12rem] aspect-video rounded overflow-hidden shadow-lg"
              key={index}
            >
      ...
      <div className="max-w-[90rem] mx-auto px-2 py-16 text-gold-dark">
        {/* Title */}
        <h1 className="text-3xl sm:text-6xl font-semibold mb-12">
          {roomClass.toUpperCase()}-{name}
        </h1>
        <p className="mb-8 text-xl sm:text-2xl md:text-3xl">{description}</p>
        <p className="mb-8 text-xl sm:text-2xl">
          Accomodates up to <strong>{maxCapacity} guests</strong>
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-12 ">
          ...
          <Feature
            ...
            label="Luxury In-Room Refreshments"
          />
          <Feature
          ...
          <Feature
            ...
            label="Wellness Pavilion Access"
          />
          <Feature
            icon={<FaParking className="w-6 h-6" />}
            label="Complimentary Valet Parking"
          />
          <Feature
          ...
          <Feature
            ...
            label="Unpacking & Packing Services"
          />
        </div>
